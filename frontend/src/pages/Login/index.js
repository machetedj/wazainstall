      ...
      <div className={"container-right"}>
        <div className={"box"}>
          <div className={"container-header-box"}>
            ...
            >
              <span className={"label-text"}>Crea una cuenta</span>
            </Link>
            <a
          ...
          <IconButton color="primary"
			onClick={() => openInNewTab(`https://wa.me/50763401190?text=Hola`)}>
				<WhatsAppIcon />
			</IconButton>
		  <Typography variant="caption">Soporte Tecnico</Typography>
