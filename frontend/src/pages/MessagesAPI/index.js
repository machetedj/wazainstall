  ...
  return (
    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes.. <br />Para registrarse acceda al menú "Conexiones", haga clic en el botón de edición de conexión e inserte el token en el campo correspondiente.</li>
          <li>
      ...
      <Typography className={classes.elementMargin} component="div">
        <b>Visita la documentacion</b><br />
        <ul>
          <li>Puedes visitar la documentacion y en el menu lateral izquierdo encontraras la documentacion API y algunos ejemplos de implementacion y solicitudes </li>
          <li>
            Estas funciones son de dificultad avanzada y estan disponibles para desarrolladores con conocimientos solidos de programacion:
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{ \"number\": \"50763401190\", \"body\": \"Su mensaje\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Typography variant="h6" color="primary" className={classes.elementMargin}>
        2. Mensajes con archivos
      </Typography>
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            <p>A continuación se muestra la lista de información necesaria para enviar mensajes de texto con archivos:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
