      ...
      return (
        <>
          <TextField
            ...
            size="small"
            className={classes.input}
            placeholder="Introduzca el la respuesta automatica"
          />
        </>
      );
    }
    ...
    <div className={classes.root}>
      ...
      <Typography>
        ...
        <Button
          ...
          variant="outlined"
        >
          Agregar autorespuesta
        </Button>
      </Typography>
      <br />
      <Typography>
        Para guardar imagenes en las autorespuesta 1- crea la autorespuesta con el boton +Agregar autorespuesta, pon el titulo y la respuesta automatica, 2- Guarda la autorespuesta con el icono guardar, 3 - vuelve a editar la autorespuesta y escoge la imagen desde el icono archivo, 4 - guarda nuevamente la autorespuesta con el icono guardar, 5 - guarda la configuracion con el boton guardar de la ventana emergente. 
        </Typography>
      {renderStepper()}
    </div>
  );
