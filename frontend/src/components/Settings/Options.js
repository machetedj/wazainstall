...
const useStyles = makeStyles((theme) => ({
  ...
  tab: {
    backgroundColor: theme.palette.options,  //DARK MODE DURKY//
    borderRadius: 4,
    width: "100%",
    "& .MuiTab-wrapper": {
      ...
      <Grid spacing={3} container>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            >
              <MenuItem value={"disabled"}>No acepto</MenuItem>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="sendGreetingAccepted-label">Enviar saludo al aceptar chat</InputLabel>
            <Select
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="sendMsgTransfTicket-label">Enviar mensaje de transferencia de chat</InputLabel>
            <Select
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            <InputLabel id="sendGreetingMessageOneQueues-label">Enviar saludo cuando solo haya 1 departamento</InputLabel>
            <Select
